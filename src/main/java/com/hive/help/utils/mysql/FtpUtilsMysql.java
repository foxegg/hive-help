...
import com.hive.help.utils.SftpLogger;
...
public class FtpUtilsMysql {
    ...
    private static String path = "/var/lib/mysql-files/logs_out/";
    ...
    public static void main(String[] args) throws ParseException {
        ...
        download(FtpUtilsMysql.getAllFileNames(HiveHelpMysql.allClientHiveClass), path + client);
        download(FtpUtilsMysql.getAllFileNames(HiveHelpMysql.allCreditHiveClass), path + credit);
        download(FtpUtilsMysql.getAllFileNames(HiveHelpMysql.allScoprioHiveClass), path + service);
    ...
    public static void downloadFile(String remotePath, String localFileName) {
        try {
            System.out.println("当前执行文件:" + remotePath + localFileName);
            ...
            System.out.println("插入数据库完成:" + remotePath + localFileName);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
